package com.shashankcdr.hospitalSystem.prescription.controller;

import com.shashankcdr.hospitalSystem.prescription.dto.CreatePrescriptionRequestDto;
import com.shashankcdr.hospitalSystem.prescription.dto.PrescriptionResponseDto;
import com.shashankcdr.hospitalSystem.prescription.service.PrescriptionService;
...
public class PrescriptionController {
    ...
    public ResponseEntity<List<PrescriptionResponseDto>> getMyPrescriptions(
        ...
        return ResponseEntity.ok(
                prescriptionService.getMyPrescriptions(username)
        );
    }
